...
APP=avidemux-qt
BIN="avidemux*qt*"
DEPENDENCES="ca-certificates libselinux avidemux-cli desktop-file-utils faac faad2 fribidi glu lame libass libdca libfdk-aac libpulse libva libvdpau libvpx libxml2 libxv opencore-amr opus qt5-base sqlite twolame x264 x265 xvidcore kvantum"
