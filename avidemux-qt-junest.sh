...
rm -f AppDir/*.desktop
LAUNCHER=$(grep -iRl "^Exec.*avidemux" archlinux/.junest/usr/share/applications/* | grep ".desktop" | head -1)
...
bind_nvidia_data_dirs="/usr/share/egl /usr/share/glvnd /usr/share/Kvantum /usr/share/nvidia /usr/share/vulkan"
...
_run_quick_sharun() {
	...
	_JUNEST_CMD -- ./quick-sharun /usr/bin/"$BIN"*qt*
...
_enable_mountpoints_for_the_inbuilt_bubblewrap() {
	...
	share_dirs="egl fonts glvnd Kvantum nvidia themes vulkan"
